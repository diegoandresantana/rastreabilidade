...
public class CidadeLogic extends GenericLogic <Cidade,Integer>{
	...
	@Override
	public Integer countAllLimit(Cidade example) {
		return daoFactory.getCidadeDAO().countAllLimit(example);
	}

	@Override
	public List<Cidade> getRegByExampleLimit(
			Cidade example, Integer posStart, Integer maximo) {
		return daoFactory.getCidadeDAO().getRegByExampleLimit(
				example, posStart, maximo);
	}
