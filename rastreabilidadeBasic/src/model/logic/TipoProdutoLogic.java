...
public class TipoProdutoLogic extends GenericLogic<TipoProduto, Integer> {
	...
	@Override
	public Integer countAllLimit(TipoProduto example) {		
		return daoFactory.getTipoProdutoDAO().countAllLimit(example);
	}

	@Override
	public List<TipoProduto> getRegByExampleLimit(TipoProduto example,Integer posStart, Integer maximo) {
		return daoFactory.getTipoProdutoDAO().getRegByExampleLimit(example, posStart, maximo);		
	}
}