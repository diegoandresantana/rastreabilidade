...
public class WinUtils {
	 ...
	 * @param param
	 *  http://localhost:8080/WebViewerExample/run?__report=Historico.rptdesign&__format=pdf&idLoteVegetal
	 *            - Paramametros que podem ser enviados a tela de busca
	 */
	public void abrirBirt(Long idlotevegetal) {
		Map<String, String> url = new HashMap<String, String>();
		String s = "/../WebViewerExample/frameset?__report=Historico.rptdesign&__format=pdf";
