...
public class Cidadelis extends WindowList<Cidade> {
	...
	public void initComponentes() {
		...
		lmUf = new ListModelList(LogicFactory.getUfLogic().getRegByExample(null));
	...
	public void pesquisar() {
		...
		pag.setTotalSize(LogicFactory.getCidadeLogic().countAllLimit(obj).intValue());
	...
	private void redraw(Cidade obj, Integer inicial, Integer maximoPermitido) {
		this.hmSis =LogicFactory.getCidadeLogic().getRegByExampleLimit(obj, inicial,
				maximoPermitido);
