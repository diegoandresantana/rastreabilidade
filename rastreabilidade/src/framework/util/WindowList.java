...
/**
 * Esta classe implementa uma Window de Listagem, <br>
 * - Pesquisar() <br>
...
public abstract class WindowList<T> extends Window implements EventListener {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2393050476234474052L;
	 ...
	 * Por definicao use o metodo <b>setListmodel</b> para popular a Lista
	 * dentro do <b>pesquisar</b>
	 */
